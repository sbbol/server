# описание формата импорта CASHLISTCASHTYPECODE

�������� �������
----------------
CashListCashTypeCode
�����������
-----------
������ ���������� ��� �� ������� � ����������� ����
�������� ������� �������
...
CashList. CashType = %COLLATE(CashType,PaymentPeriodStr);
...
CashList. CashTypeCode = CashTypeCode;
CashList. PaymentPeriodStr = PaymentPeriodStr;

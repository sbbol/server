...
INTENT_RULES: tuple[IntentRule, ...] = (
    ...
    IntentRule(
        ...
        none_of=("банк", "оператор", "поддержк", "карт", "бизнес", "корпоратив", "перевед"),
    ),
    IntentRule(
        id="list_user_cards",
        response_mode=ResponseMode.DATA,
        priority=93,
        tool="get_user_cards",
        any_of=("у меня", "мои", "моих", "есть ли", "есть активн", "есть у меня"),
        fuzzy_roots=("карт",),
        none_of=(
            "заблокир", "блокиров", "заказ", "оформ", "созда", "перейти", "экран", "страниц",
            "бывают", "расскаж", "объясни", "что такое", "чем отлича",
        ),
    ),
    IntentRule(
        id="nav_cards_screen",
        ...
        priority=75,
        tool="navigate",
        tool_args={"screen": "card_management", "label": "Управление картами"},
        all_of=("карт",),
        any_of=("экран", "перейти", "переход", "покаж", "страниц", "открой"),
        none_of=("заблокир", "заказ", "оформ", "созда"),
    ),
    IntentRule(
        id="list_drafts",
        response_mode=ResponseMode.DATA,
    ...
    IntentRule(
        ...
        none_of=("сколько", "баланс", "остаток", "реквизит", "выписк", "карт"),
    ),
)
